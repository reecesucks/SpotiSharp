	...
	public static MauiApp CreateMauiApp()
	{
		...
		builder
			...
			.ConfigureFonts(fonts =>
			{
				...
				// Chicago Kare by Duane King (MIT) — Susan Kare's 1984 Chicago, used by the iPod theme
				fonts.AddFont("ChicagoKare-Regular.ttf", "ChicagoKare");
			});
		...
		SpotiSharpBackend.DiagnosticLog.SetDirectory(FileSystem.AppDataDirectory);
		SpotiSharpBackend.DiagnosticLog.Write("[App] session started");
